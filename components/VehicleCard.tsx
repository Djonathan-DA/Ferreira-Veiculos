    ...
    <article className="card-lift group flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-night-700">
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <a
          ...
          className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-b from-[#2ee06f] to-[#1faa52] px-4 py-3 text-sm font-bold text-night transition-transform hover:scale-[1.02]"
        >
